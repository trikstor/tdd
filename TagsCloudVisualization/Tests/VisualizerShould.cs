...
namespace TagsCloudVisualization
{
    ...
    public class VisualizerShould
    {
        ...
        {
            Action res = () => { new Visualizer(new Point(0, 0));};
        ...
        {
            Action res = () => { new Visualizer(new Point(5, 1)); };
            res.ShouldNotThrow();
        }
        ...
        {
            Action res = () => { new Visualizer(new Point(0, 0), 100); };
            res.ShouldThrow<ArgumentException>()
                .WithMessage("Координаты центра должны быть больше нуля.");
        }
        ...
        {
            Action res = () => { new Visualizer(new Point(10, 10), 0); };
        ...
        {
            Action res = () => { new Visualizer(new Point(10, 10), 100); };
            res.ShouldNotThrow();
        }
    }
}
